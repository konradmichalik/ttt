...
/**
 * ApplicationContextHandlerFunctionalTestCaseGuardTest.
 *
 * Extends the typo3/testing-framework stub (see tests/stubs), not PHPUnit's
 * plain TestCase, to prove #[InApplicationContext] fails loudly on
 * FunctionalTestCase - even before checking whether an Environment exists.
 *
 * @author Konrad Michalik <hej@konradmichalik.dev>
 * @license GPL-3.0-or-later
 */
#[CoversClass(ApplicationContextHandler::class)]
final class ApplicationContextHandlerFunctionalTestCaseGuardTest extends FunctionalTestCase
{
    #[Test]
    public function applyFailsLoudlyOnFunctionalTestCase(): void
    {
        $this->expectException(RuntimeException::class);
        $this->expectExceptionMessage('InApplicationContext cannot be used on FunctionalTestCase');
